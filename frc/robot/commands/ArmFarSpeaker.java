...
public class ArmFarSpeaker extends Command {
  /** Creates a new ShoulderPositionA. */
  ShoulderArmSubsystem m_shoulderArmSubsystem;
  WristSubsystem m_wristSubsystem;

  public ArmFarSpeaker(ShoulderArmSubsystem m_shoulderArmSubsystem, WristSubsystem m_wristSubsystem) {
  ...
  @Override
  public void execute() {
   m_shoulderArmSubsystem.speakerScore();
   m_wristSubsystem.farSpeakerScore(); //was speaker score for some reason?
